...
class Appointments1 extends StatefulWidget {
  const Appointments1({Key? key, required this.dateController})
      : super(key: key);
  final dateController;

  @override
  State<Appointments1> createState() => _Appointments1();
}

class _Appointments1 extends State<Appointments1> {
